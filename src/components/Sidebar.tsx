...
export default function Sidebar() {
  ...
  return (
    <aside className="z-49 w-64 h-[calc(100vh-64px)] mt-[64px] bg-white/10 backdrop-blur-md border-r border-white/20 shadow-md flex flex-col justify-start  px-4 py-6 fixed top-0 left-0">

      <div className="flex flex-col items-start mt-10 mb-10 gap-5 text-lg">
        <Link href="/chat/ask">
          <button
